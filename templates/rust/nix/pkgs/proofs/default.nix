...
stdenvNoCC.mkDerivation {
  ...
  buildPhase =
    ...
    ''
      ...
      lean \
        --root=$LEAN_SRC_PATH \
        -o .lake/build/lib/lean/Libtemplate/Types.olean \
        .lake/build/lib/lean/Libtemplate/Types.lean

      lean \
        --root=$LEAN_SRC_PATH \
        -o .lake/build/lib/lean/Libtemplate/Funs.olean \
        .lake/build/lib/lean/Libtemplate/Funs.lean

      lean \
        --root=$LEAN_SRC_PATH \
        -o .lake/build/lib/lean/Libtemplate.olean \
        .lake/build/lib/lean/Libtemplate.lean

      # Build the Lean proofs project
      # Lean will now find the precompiled Aeneas modules and
      # compile Libtemplate and Proofs
  ...
  installPhase = ''
        ...
        cat > "$out/nix-support/verification-info" <<INFO
    Lean Proofs Build
    =================
